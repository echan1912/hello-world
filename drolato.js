...
$('.checkout-button').click(function() {
  ...
  // Get the quantity of scoops of items //
...
const price_coconut_mango = coconut_mango_price * getQuantityCoconutMango
const price_salted_caramel = salted_caramel_price * getQuantitySaltedCaramel
const price_strawberries_cream = strawberries_cream_price * getQuantityStrawberriesCream
